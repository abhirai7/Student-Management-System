...
public class Student extends JFrame {
	...
	public Student() {
		...
		contentPane.setBackground(new Color(78, 89, 140));
		...
		entryNumber.setForeground(Color.WHITE);
		...
		homeCity.setForeground(Color.WHITE);
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					con = DriverManager.getConnection("jdbc:mysql://localhost/studentmanagementsystem", "root", "Abhishek@1234");
					...
					if((sname.getText().equals("") || sentry.getText().equals("") || semail.getText().equals("") || scontact.getText().equals("") || shome.getText().equals("") )) {
						JOptionPane.showMessageDialog(null, "Fill all the correct details :(");
					}
					else {
						pst.executeUpdate();
		...
		desktopPane_1.setBackground(new Color(249, 199, 132));
		
		JDesktopPane desktopPane_2 = new JDesktopPane();
		desktopPane_2.setBackground(new Color(249, 199, 132));
		
		JDesktopPane desktopPane_3 = new JDesktopPane();
		desktopPane_3.setBackground(new Color(249, 199, 132));
